...
export const courseCatalog: CourseItem[] = [
  {
    id: 1,
    title: 'Интернет-магазин смартфонов: Vue + Node.js',
    description:
      'Полноценный Fullstack интернет-магазин (SPA), разработанный в рамках курсовой работы. Реализован каталог с "живым" поиском, страницы товаров, выезжающая корзина с сохранением в LocalStorage (Pinia) и форма оформления заказа с транзакциями на стороне бэкенда.',
    price: 80,
    imagePath: 'images/product9/image1.png',
    galleryPaths: [
      'images/product9/image2.png',
      'images/product9/image3.png',
      'images/product9/image4.png',
      'images/product9/image5.png',
      'images/product9/image6.png',
      'images/product9/image7.png',
      'images/product9/image9.png',
      'images/product9/image10.png',
      'images/product9/image11.png',
    ],
    tags: ['Vue.js', 'Node.js', 'TypeScript', 'SQL Server', 'Express', 'Pinia', 'Fullstack', 'SPA'],
  },
  {
    id: 2,
